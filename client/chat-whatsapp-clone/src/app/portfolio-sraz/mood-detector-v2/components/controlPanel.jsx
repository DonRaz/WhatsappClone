...
const moodOptions = [
  { value: 'happy', label: 'Happy', icon: Smile, emoji: '😊' },
  { value: 'sad', label: 'Sad', icon: Heart, emoji: '😢' },
  { value: 'sleepy', label: 'Sleepy', icon: Moon, emoji: '😴' },
  { value: 'angry', label: 'Angry', icon: Zap, emoji: '😠' },
