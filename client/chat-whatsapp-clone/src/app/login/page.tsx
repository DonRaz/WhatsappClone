...
function LoginContent() {
  ...
  const returnUrl = searchParams.get('returnUrl') || '/conversations'; // Default to conversations if no returnUrl
  ...
  const { mutate: loginMutate, isPending: loginIsPending, error: loginError } = useLogin();
  const { mutate: registerMutate, isPending: registerIsPending, error: registerError } = useRegister();
