		...
		<div className="flex-1 flex flex-col overflow-hidden bg-secondary h-full min-w-0">
			...
			>
				...
				>
					...
					<div ref={topMessageRef} style={{ height: '1px', width: '100%', background: 'transparent', pointerEvents: 'none' }} aria-hidden="true">
						{isFetchingNextPage && (
					...
					{/* Render Messages */}
					{messages.length > 0
						? messages.map((message) => ( // Removed index, key on ChatItem
								<ChatItem
									key={message.id}
									message={message}
