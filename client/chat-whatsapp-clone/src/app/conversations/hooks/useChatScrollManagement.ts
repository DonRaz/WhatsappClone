...
export function useChatScrollManagement({
  ...
  }, [enabled, chatId, listLength, isLoadingHistory, scrollContainerRef]);
  ...
  }, [enabled, chatId, listLength, isLoadingHistory, isLoadingMessages, scrollContainerRef, bottomRef]);
